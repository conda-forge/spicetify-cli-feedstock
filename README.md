...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/spicetify-cli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/spicetify-cli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add spicetify-cli
# for installing globally
pixi global install spicetify-cli
```
...
It is possible to list all of the versions of `spicetify-cli` available on your platform:
...
```
pixi search spicetify-cli --channel conda-forge
```
